...
exports.subscriptionReminderTemplate = void 0;
const mjml_1 = __importDefault(require("mjml"));
const subscriptionReminderTemplate = ({ organizationName, planName, expiryDate, daysLeft, renewLink, }) => {
    const { html } = (0, mjml_1.default)(`
<mjml>
  <mj-head>
...
exports.subscriptionReminderTemplate = subscriptionReminderTemplate;
