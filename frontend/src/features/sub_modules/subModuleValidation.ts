...
export const subModuleSchema = z.object({
  module_id: z
    .number()
    .int()
    .positive("Parent module is required"),
  ...
  sub_module_code: z
    ...
    .max(
      50,
      "Sub module code must not exceed 50 characters",
    ),
  ...
  sub_module_name: z
    ...
    .max(
      100,
      "Sub module name must not exceed 100 characters",
    ),
  ...
  permissions: z
    ...
    .min(
      1,
      "At least one role permission is required",
    ),
})
